        ...
        <div class="col-sm-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Data Detail Tamu <?php echo $row['nama_pelanggan']; ?></h3>
                </div>
                <!-- /.box-header -->
				...
				<tr>
				  ...
				  <td><center>Keterangan Penolakan</center></td>
				...
				<tr>
                  ...
                  <td><center><img src = <?php echo base_url()?><?php echo $row['file_loc'];?> width="400px" height="400px"></center></td>
                    ...
                    <div class="box-footer">
                        <?php
                        echo anchor('tamutolak', 'Kembali', array('class' => 'btn btn-default'));
                        ?>
                    </div>
                </div>
                <!-- /.box-body -->
